...
pub struct ScenarioReconciliation {}

impl ScenarioReconciliation {
    pub fn new() -> Self {
        Self {}
    }
}
...
#[async_trait]
impl TestScenarioBuilder for ScenarioReconciliation {
    async fn get_scenario(&self) -> Result<TestScenario, DbErr> {
        ...
        let assert_results: AssertResult = vec![
            ...
            (
                ...
                Decimal::new(-150000, 2), // March rent on the 1st
            ),
            (
                account.id,

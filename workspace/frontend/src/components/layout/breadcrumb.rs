...
pub fn breadcrumb() -> Html {
    ...
    let breadcrumb_items = if let Some(route) = location.as_ref().and_then(|loc| {
        ...
        match route {
            ...
            Route::RecurringDetail { id } => vec![
                BreadcrumbItem { label: "Home".to_string(), route: Route::Dashboard },
                BreadcrumbItem { label: "Recurring".to_string(), route: Route::Recurring },
                BreadcrumbItem { label: format!("Recurring #{}", id), route: Route::RecurringDetail { id } }
            ],
            Route::Instances => vec![
                BreadcrumbItem { label: "Home".to_string(), route: Route::Dashboard },
            ...
            Route::Scenarios => vec![
                BreadcrumbItem { label: "Home".to_string(), route: Route::Dashboard },
                BreadcrumbItem { label: "Scenarios".to_string(), route: Route::Scenarios }
            ],
            Route::ScenarioDetail { id } => vec![
                BreadcrumbItem { label: "Home".to_string(), route: Route::Dashboard },
                BreadcrumbItem { label: "Scenarios".to_string(), route: Route::Scenarios },
                BreadcrumbItem { label: format!("Scenario #{}", id), route: Route::ScenarioDetail { id } }
            ],
            Route::Budgets => vec![
                BreadcrumbItem { label: "Home".to_string(), route: Route::Dashboard },

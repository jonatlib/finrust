...
use super::{AccountCashflowChart, AccountChart, AccountForecast, AccountMetrics, AccountMinBalanceChart, AccountStats, GoalProgress};
                    ...
                    html! {
                        <>
                            ...
                            <div class="space-y-6">
                                ...
                                <AccountMinBalanceChart account_id={account_id} />
